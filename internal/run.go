...
import (
	...
	"github.com/prologic/box/container"
	"github.com/prologic/box/image"
	"github.com/prologic/box/network"
	"github.com/prologic/box/reexec"
)
...
func Run(cmd *cobra.Command, args []string) error {
	...
	// setup bridge
	if err := network.SetupBridge(bridgeInterface); err != nil {
		return err
	}

	// setup network
	deleteNetwork, err := ctr.SetupNetwork(bridgeInterface)
	if err != nil {
		return err
	}
	defer deleteNetwork()
